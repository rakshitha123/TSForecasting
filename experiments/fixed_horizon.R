...
do_fixed_horizon_global_forecasting("sample", 65, "sample.tsf", "series_name", "start_timestamp", 8)
...
do_fixed_horizon_global_forecasting("cif_2016", 15, "cif_2016_dataset.tsf")
do_fixed_horizon_global_forecasting("nn5_daily", 9, "nn5_daily_dataset_without_missing_values.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("tourism_yearly", 2, "tourism_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("tourism_quarterly", 5, "tourism_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("tourism_monthly", 15, "tourism_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m1_yearly", 2, "m1_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m1_quarterly", 5, "m1_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m1_monthly", 15, "m1_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m3_yearly", 2, "m3_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m3_quarterly", 5, "m3_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m3_monthly", 15, "m3_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m3_other", 2, "m3_other_dataset.tsf")
do_fixed_horizon_global_forecasting("m4_yearly", 2, "m4_yearly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m4_quarterly", 5, "m4_quarterly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m4_monthly", 15, "m4_monthly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m4_weekly", 65, "m4_weekly_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m4_daily", 9, "m4_daily_dataset.tsf", "series_name", "start_timestamp")
do_fixed_horizon_global_forecasting("m4_hourly", 210, "m4_hourly_dataset.tsf", "series_name", "start_timestamp")
...
do_fixed_horizon_global_forecasting("car_parts", 15, "car_parts_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 12, TRUE)
do_fixed_horizon_global_forecasting("hospital", 15, "hospital_dataset.tsf", "series_name", "start_timestamp", 12, TRUE)
do_fixed_horizon_global_forecasting("fred_md", 15, "fred_md_dataset.tsf", "series_name", "start_timestamp", 12)
...
do_fixed_horizon_global_forecasting("nn5_weekly", 65, "nn5_weekly_dataset.tsf", "series_name", "start_timestamp", 8)
do_fixed_horizon_global_forecasting("traffic_weekly", 65, "traffic_weekly_dataset.tsf", "series_name", "start_timestamp", 8)
do_fixed_horizon_global_forecasting("electricity_weekly", 65, "electricity_weekly_dataset.tsf", "series_name", "start_timestamp", 8, TRUE)
do_fixed_horizon_global_forecasting("solar_weekly", 6, "solar_weekly_dataset.tsf", "series_name", "start_timestamp", 5)
do_fixed_horizon_global_forecasting("kaggle_web_traffic_weekly", 10, "kaggle_web_traffic_weekly_dataset.tsf", "series_name", "start_timestamp", 8, TRUE)
do_fixed_horizon_global_forecasting("dominick", 10, "dominick_dataset.tsf", NULL, NULL, 8)
...
do_fixed_horizon_global_forecasting("us_births", 9, "us_births_dataset.tsf", "series_name", "start_timestamp", 30, TRUE)
do_fixed_horizon_global_forecasting("saugeen_river_flow", 9, "saugeenday_dataset.tsf", "series_name", "start_timestamp", 30)
do_fixed_horizon_global_forecasting("sunspot", 9, "sunspot_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 30, TRUE)
do_fixed_horizon_global_forecasting("covid_deaths", 9, "covid_deaths_dataset.tsf", "series_name", "start_timestamp", 30, TRUE)
do_fixed_horizon_global_forecasting("weather", 9, "weather_dataset.tsf", NULL, NULL, 30)
...
do_fixed_horizon_global_forecasting("elecdemand", 420, "elecdemand_dataset.tsf", "series_name", "start_timestamp", 336)
do_fixed_horizon_global_forecasting("traffic_hourly", 30, "traffic_hourly_dataset.tsf", "series_name", "start_timestamp", 168)
do_fixed_horizon_global_forecasting("electricity_hourly", 30, "electricity_hourly_dataset.tsf", "series_name", "start_timestamp", 168, TRUE)
do_fixed_horizon_global_forecasting("solar_10_minutes", 50, "solar_10_minutes_dataset.tsf", "series_name", "start_timestamp", 1008)
do_fixed_horizon_global_forecasting("kdd_cup", 210, "kdd_cup_2018_dataset_without_missing_values.tsf", "series_name", "start_timestamp", 168)
do_fixed_horizon_global_forecasting("melbourne_pedestrian_counts", 210, "pedestrian_counts_dataset.tsf", "series_name", "start_timestamp", 24, TRUE)
